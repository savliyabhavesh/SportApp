        ...
        public async Task Agent1()
        {
            ...
            try
            {
                ...
                while (oleDbDataReader.Read())
                {
                    ...
                    if (Operators.CompareString(status, "Booky", false) == 0)
                    {
                        if (Operators.CompareString(aparty, ComboBox1.Text, false) == 0)
                        {
                            if (num9 < 0)
                            {
                        ...
                        if (Operators.CompareString(tparty, ComboBox1.Text, false) == 0)
                        {
                            if (num9 < 0)
                            {
        ...
        public async Task Agent2()
        {
            ...
            try
            {
                ...
                while (oleDbDataReader.Read())
                {
                    ...
                    if (Operators.CompareString(status, "Booky", false) == 0)
                    {
                        if (Operators.CompareString(aparty, ComboBox3.Text, false) == 0)
                        {
                            if (num9 < 0)
                            {
                                double num101 = Conversion.Val(afterldamt1) * Conversion.Val(amatch) / 100;
                        ...
                        if (Operators.CompareString(tparty, ComboBox3.Text, false) == 0)
                        {
                            if (num9 < 0)
                            {
                                double num101 = Conversion.Val(afterldamt1) * Conversion.Val(tmatch) / 100;
