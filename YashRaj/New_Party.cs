            ...
            try
            {
                if (Module1.modifypartyid != 0 && Module1.modifypartyname != "")
                {
                    ...
                    if (oleDbDataReader.Read())
                    {
                        ...
                        txtOpeningBal.Text = Conversion.Val(oleDbDataReader["OpeningBalance"]) != 0 ? Conversions.ToString(oleDbDataReader["OpeningBalance"]) : "0";
